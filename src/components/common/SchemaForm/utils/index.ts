import type { RulePresets, RulePresetsType, Schema } from '@/components/common/SchemaForm/types/common.ts'
import type { ComponentsName } from '@/components/common/SchemaForm/types/component'
